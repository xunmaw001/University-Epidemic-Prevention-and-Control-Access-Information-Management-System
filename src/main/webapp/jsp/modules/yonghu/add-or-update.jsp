    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuXueyuan: "required",
                yonghuZhuanye: "required",
                yonghuBanji: "required",
                yonghuNianji: "required",
            },
            messages: {
                yonghuXuegonghao: "学工号不能为空",
                username: "账户不能为空",
                password: "密码不能为空",
                yonghuName: "用户姓名不能为空",
                sexTypes: "性别不能为空",
                ...
                yonghuPhone: "手机号不能为空",
                yonghuPhoto: "照片不能为空",
                yonghuXueyuan: "学院不能为空",
                yonghuZhuanye: "专业不能为空",
                yonghuBanji: "班级不能为空",
                yonghuNianji: "年级不能为空",
            }
        }).form();
