            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑打卡记录</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="dakajiluTiwen" name="dakajiluTiwen" class="form-control"
                                               onchange="dakajiluTiwenChickValue(this)" placeholder="体温">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>打卡地点</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("dakajilu/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function insertTimeChickValue(e){
        ...
        function dakajiluTiwenChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                insertTime: "required",
                dakajiluTiwen: "required",
                dakajiluDidian: "required",
    ...
    // 获取当前详情
    function getDetails() {
        var adddakajilu = window.sessionStorage.getItem("adddakajilu");
        if (adddakajilu != null && adddakajilu != "" && adddakajilu != "null") {
            window.sessionStorage.removeItem('adddakajilu');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("dakajilu/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#dakajiluTiwen").val(ruleForm.dakajiluTiwen);
        $("#dakajiluDidian").val(ruleForm.dakajiluDidian);
