...
public class YonghuEntity<T> implements Serializable {
     ...
     * 学工号
     */
    @TableField(value = "yonghu_xuegonghao")
     ...
     * 学院
     */
    @TableField(value = "yonghu_xueyuan")
     ...
     * 年级
     */
    @TableField(value = "yonghu_nianji")
    ...
    public String toString() {
        return "Yonghu{" +
            "id=" + id +
            ", yonghuXuegonghao=" + yonghuXuegonghao +
            ", username=" + username +
            ", password=" + password +
            ...
            ", yonghuXueyuan=" + yonghuXueyuan +
            ", yonghuZhuanye=" + yonghuZhuanye +
            ", yonghuBanji=" + yonghuBanji +
            ", yonghuNianji=" + yonghuNianji +
